...
describe "Service Catalogs API" do
  def sc_template_url(id, st_id = nil)
    st_base = "#{service_catalog_url(nil, id)}/service_templates"
  ...
  describe "Service Catalogs edit" do
    it "rejects resource edits without appropriate role" do
      ...
      run_post(service_catalogs_url, gen_request(:edit, "name" => "sc1", "href" => service_catalog_url(nil, 999_999)))
    ...
    it "rejects edits for invalid resources" do
      ...
      run_post(service_catalog_url(nil, 999_999), gen_request(:edit, "description" => "updated sc description"))
    ...
    it "supports single resource edit" do
      ...
      run_post(service_catalog_url(nil, sc.id), gen_request(:edit, "description" => "updated sc description"))
    ...
    it "supports multiple resource edits" do
      ...
      run_post(service_catalogs_url, gen_request(:edit,
                                                 [{"href" => service_catalog_url(nil, sc1.id), "name" => "sc1 updated"},
                                                  {"href" => service_catalog_url(nil, sc2.id), "name" => "sc2 updated"}]))
  ...
  describe "Service Catalogs delete" do
    it "rejects deletion without appropriate role" do
      ...
      run_post(service_catalogs_url, gen_request(:delete, "name" => "sc1", "href" => service_catalog_url(nil, 100)))
    ...
    it "rejects resource deletion without appropriate role" do
      ...
      run_delete(service_catalog_url(nil, 100))
    ...
    it "rejects resource deletes for invalid resources" do
      ...
      run_delete(service_catalog_url(nil, 999_999))
    ...
    it "supports single resource deletes" do
      ...
      run_delete(service_catalog_url(nil, sc.id))
    ...
    it "supports resource deletes via action" do
      ...
      run_post(service_catalog_url(nil, sc.id), gen_request(:delete))

      expect_single_action_result(:success => true, :message => "deleting", :href => service_catalog_url(nil, sc.id))
      expect { sc.reload }.to raise_error(ActiveRecord::RecordNotFound)
    end
    ...
    it "supports multiple resource deletes" do
      ...
      run_post(service_catalogs_url, gen_request(:delete,
                                                 [{"href" => service_catalog_url(nil, sc1.id)},
                                                  {"href" => service_catalog_url(nil, sc2.id)}]))
      expect_multiple_action_result(2)
      expect_result_resources_to_include_hrefs("results", [service_catalog_url(nil, sc1.id), service_catalog_url(nil, sc2.id)])
  ...
  describe "Service Catalogs service template assignments" do
    it "rejects assign requests without appropriate role" do
      ...
      run_post(sc_template_url(100), gen_request(:assign, "href" => service_template_url(nil, 1)))
    ...
    it "rejects unassign requests without appropriate role" do
      ...
      run_post(sc_template_url(100), gen_request(:unassign, "href" => service_template_url(nil, 1)))
    ...
    it "rejects assign requests with invalid service template" do
      ...
      run_post(sc_template_url(sc.id), gen_request(:assign, "href" => service_template_url(nil, 999_999)))

      expect(response).to have_http_status(:ok)
      expect_results_to_match_hash("results", [{"success" => false, "href" => service_catalog_url(nil, sc.id)}])
    end
    ...
    it "supports assign requests" do
      ...
      run_post(sc_template_url(sc.id), gen_request(:assign, "href" => service_template_url(nil, st.id)))

      expect(response).to have_http_status(:ok)
      expect_results_to_match_hash("results", [{"success"               => true,
                                                "href"                  => service_catalog_url(nil, sc.id),
                                                "service_template_id"   => st.id,
                                                "service_template_href" => /^.*#{service_template_url(nil, st.id)}$/,
                                                "message"               => /assigning/i}])
    ...
    it "supports unassign requests" do
      ...
      run_post(sc_template_url(sc.id), gen_request(:unassign, "href" => service_template_url(nil, st1.id)))

      expect(response).to have_http_status(:ok)
      expect_results_to_match_hash("results", [{"success"               => true,
                                                "href"                  => service_catalog_url(nil, sc.id),
                                                "service_template_id"   => st1.id,
                                                "service_template_href" => /^.*#{service_template_url(nil, st1.id)}$/,
  ...
  describe "Service Catalogs service template ordering" do
    ...
    it "rejects order requests without appropriate role" do
      ...
      run_post(sc_template_url(100), gen_request(:order, "href" => service_template_url(nil, 1)))
    ...
    it "supports multiple order requests" do
      ...
      run_post(sc_template_url(sc.id), gen_request(:order, [{"href" => service_template_url(nil, st1.id)},
                                                             {"href" => service_template_url(nil, st2.id)}]))
      expect(response).to have_http_status(:ok)
